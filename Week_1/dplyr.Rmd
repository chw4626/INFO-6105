...
Note: the following comes directly from the [dplyr](https://cran.rstudio.com/web/packages/dplyr/) documentation [Introduction to dplyr](https://cran.rstudio.com/web/packages/dplyr/vignettes/introduction.html). It is just in an .Rmd format so you can play with it.  
