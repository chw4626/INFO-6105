---
title: "Functions from Advanced R by Hadley Wickham"
author: "Hadley Wickham & Bear"
output:
...
This lesson mostly comes from [Advanced R by Hadley Wickham](http://adv-r.had.co.nz/)

# Functions

R provides many built-in functions such as *lm()* and *summary()*. User-defined functions allow a programmer to reuse code within a program. They are the building blocks of a well defined program and the basis of packages that extend R's functionality. Functions are used to organize lengthy codes in a way that is easier to read and understand. The also prevent duplicate code which can led to errors. 

Functions have three parts: a function definition, a function body and a function call.
...
Functions make a part of virtually every programming language and are an essential for software development and maintenance. Learning how to develop functions will allow you to write libraries wich can contain complex algorithms. You can then keep growing your libraries until it becomes fast and easy.

Tips:

* Choose a naming convention and stick to it.  
* Data definitions /Signature -	Data description. What goes in and what comes out of the functions that you write.  
* Purpose statement	-	Concise description of what your functions/classes do.   
* Examples - Examples of the use of your functions/classes.
* Tests	- Tests for your functions/classes.
* Pseudocode	- Text description of your algorithm.  

# Coding Style 

See coding style on BB.
